...
# Тестирование считывания файла, вывода сообщений об ошиках в консоль и возврата результатов
@pytest.mark.parametrize("file_name, expected_result, expected_message",
